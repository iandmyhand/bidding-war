...
import com.study.biddingwar.common.crypto.CryptoAesUtils
...
class RequestAESDecryptWrapper: HttpServletRequestWrapper{

    var body:String

    constructor(request: HttpServletRequest, secretKey: String) : super(request) {
        ...
        if (encryptData != null && !encryptData.isEmpty()) {
            val iv = secretKey
            deCryptData = CryptoAesUtils.decryptAES128Msg(encryptData, secretKey, iv)
            if (deCryptData == null) {
